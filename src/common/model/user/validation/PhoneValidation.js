...
PhoneValidation.prototype.URL_FETCH = "/sms/phone/validation/app/fetch";
...
PhoneValidation.prototype.httpFetch = function (phone, successCallback, failureCallback) {
  let that = this;
  console.log(phone);
  ...
  this.httpPost(this.URL_FETCH, form, function (response) {
    that.coldDown();
